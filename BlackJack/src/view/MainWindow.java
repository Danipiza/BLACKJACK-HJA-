...
public class MainWindow extends JFrame {
	...
	private void addPlayerCard() {
		...
		JLabel carta1 = game.getPlayerCards().get(0).toImage();
		//JLabel carta1 = new JLabel(new ImageIcon("resources/icons/" + 2 + "_of_" + "spades" + ".png"));
		tablero.add(carta1);
		carta1.setBounds(200, 500, 75, 110);
		
		JLabel carta2 = game.getPlayerCards().get(1).toImage();
		tablero.add(carta2);
		carta2.setBounds(295, 500, 75, 110);
		
		playerCards.add(carta1);
		playerCards.add(carta2);
		//tablero.add(carta);	
	}
